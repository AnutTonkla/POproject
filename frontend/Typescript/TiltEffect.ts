...
class TiltEffect {
    ...
    private readonly maxRotate: number = 8; // องศาการเอียงสูงสุด
    ...
    private init(): void {
        this.elements.forEach(element => {
            ...
            element.addEventListener('mousemove', (e: MouseEvent) => this.handleMouseMove(e, element));
            element.addEventListener('mouseleave', () => this.handleMouseLeave(element));
        });
    }

    private handleMouseMove(e: MouseEvent, el: HTMLElement): void {
    ...
    private handleMouseLeave(el: HTMLElement): void {
